...
import com.dboy.chips.cache.ViewCacheFactory;
import com.dboy.chips.gravity.CenterChildGravity;
import com.dboy.chips.gravity.CustomGravityResolver;
import com.dboy.chips.gravity.IChildGravityResolver;
import com.dboy.chips.layouter.AbstractPositionIterator;
import com.dboy.chips.layouter.ColumnsStateFactory;
import com.dboy.chips.layouter.ICanvas;
import com.dboy.chips.layouter.ILayouter;
import com.dboy.chips.layouter.IMeasureSupporter;
import com.dboy.chips.layouter.IStateFactory;
import com.dboy.chips.layouter.LayouterFactory;
import com.dboy.chips.layouter.MeasureSupporter;
import com.dboy.chips.layouter.RowsStateFactory;
import com.dboy.chips.layouter.breaker.EmptyRowBreaker;
...
import com.dboy.chips.layouter.placer.PlacerFactory;
import com.dboy.chips.testing.EmptySpy;
import com.dboy.chips.testing.ISpy;
...
public class ChipsLayoutManager extends RecyclerView.LayoutManager implements IChipsLayoutManagerContract,
    ...
    // inner constants
    ///////////////////////////////////////////////////////////////////////////
    private static final String TAG = com.dboy.chips.ChipsLayoutManager.class.getSimpleName();
    ...
    /**
     * when scrolling reached this position {@link com.dboy.chips.ChipsLayoutManager} is able to restore items layout according to cached items with positions above.
    ...
    /** used for testing purposes to spy for {@link com.dboy.chips.ChipsLayoutManager} behaviour */
    ...
    public static Builder newBuilder(Context context) {
        ...
        return new com.dboy.chips.ChipsLayoutManager(context).new StrategyBuilder();
    }
    ...
    public class StrategyBuilder extends Builder {
        ...
        public Builder withLastRow(boolean withLastRow) {
            com.dboy.chips.ChipsLayoutManager.this.isStrategyAppliedWithLastRow = withLastRow;
            return this;
        }
    ...
    public class Builder {
        ...
        public Builder setScrollingEnabled(boolean isEnabled) {
            com.dboy.chips.ChipsLayoutManager.this.setScrollingEnabledContract(isEnabled);
            return this;
        }
        ...
        public StrategyBuilder setRowStrategy(@RowStrategy int rowStrategy) {
            com.dboy.chips.ChipsLayoutManager.this.rowStrategy = rowStrategy;
        ...
        public Builder setMaxViewsInRow(@IntRange(from = 1) int maxViewsInRow) {
            if (maxViewsInRow < 1)
                throw new IllegalArgumentException("maxViewsInRow should be positive, but is = " + maxViewsInRow);
            com.dboy.chips.ChipsLayoutManager.this.maxViewsInRow = maxViewsInRow;
            return this;
        }
        ...
        public Builder setRowBreaker(@NonNull IRowBreaker breaker) {
            ...
            com.dboy.chips.ChipsLayoutManager.this.rowBreaker = breaker;
            return this;
        }
        ...
        public Builder setOrientation(@Orientation int orientation) {
            ...
            com.dboy.chips.ChipsLayoutManager.this.layoutOrientation = orientation;
            return this;
        }
         ...
         */
        public com.dboy.chips.ChipsLayoutManager build() {
            ...
            stateFactory = layoutOrientation == HORIZONTAL ? new RowsStateFactory(com.dboy.chips.ChipsLayoutManager.this) : new ColumnsStateFactory(com.dboy.chips.ChipsLayoutManager.this);
            ...
            return com.dboy.chips.ChipsLayoutManager.this;
        }
     ...
     *
     * Also this is {@link com.dboy.chips.ChipsLayoutManager} specific issue, that we can't predict exact count of items on screen
     ...
     *     <li> You have {@link com.dboy.chips.ChipsLayoutManager#setMaxViewsInRow(Integer)} set and you able to make sure, that there won't be many rows with lower items count.
     *     The best is none. </li>
     * </ul>
     *
    ...
    public com.dboy.chips.VerticalScrollingController verticalScrollingController() {
        return new com.dboy.chips.VerticalScrollingController(this, stateFactory, this);
    }

    public com.dboy.chips.HorizontalScrollingController horizontalScrollingController() {
        return new com.dboy.chips.HorizontalScrollingController(this, stateFactory, this);
    }
